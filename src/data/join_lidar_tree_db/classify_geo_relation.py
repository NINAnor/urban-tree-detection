...
if arcpy.Exists(fc_case_1):
    ...
    au.calculateField_ifEmpty(fc_case_1, field=field_geo_relation, expression= "Case 1")
...
if arcpy.Exists(fc_case_2):
    ...
    au.calculateField_ifEmpty(fc_case_2, field=field_geo_relation, expression= "Case 2")
