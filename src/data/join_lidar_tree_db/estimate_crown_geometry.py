...
#       -> crown width estimated by NINA equation

   
codeblock = """def calculateRadius(cd_orig, dbh_orig, it_code, itree_width, dbh_cm):
    if cd_orig == "ALS, intersecting BYM, Thiessen" or cd_orig == "ALS, intersecting BYM, LiDAR":
        ...
        return None
"""   
#arcpy.CalculateField_management(v_trees, "temp_crown_radius", "calculateRadius(!CD_origin!, !DBH_origin!, !it_code!, !crown_width_itree!, !DBH_corr_cm!)", "PYTHON_9.3", codeblock)

# 2. compute buffer
#v_buffer = "temp_cd_1_buffer"
#arcpy.Buffer_analysis(v_trees, v_buffer, "temp_crown_radius", "", "", "ALL")    
...
#l_trees = arcpy.MakeFeatureLayer_management (v_trees, "trees_layer")
...
#join_and_copy(v_trees, "TREE_ID", v_crown_laser_merged, "TREE_ID", ["CROWN_ID", "MGBDIAM", "N_S_WIDTH", "E_W_WIDTH", "origin"], ["CROWN_ID", "MGBDIAM", "N_S_WIDTH", "E_W_WIDTH", "CD_origin"])
