...
def split_chm(split_neighbourhoods_gdb, neighbourhood_list, r_chm, gdb_split_chm):
    ...
    for n_code in neighbourhood_list:
        ...
        r_chm_neighb = os.path.join(gdb_split_chm, "chm_" + "b_" + n_code + "_buffer200")
...
if __name__ == '__main__':
    ...
    # end list til ..10
    neighbourhood_list = ['180401', '180402','180403', '180404', '180405', '180406', \
        '180407', '180408', '180409', '180410'] # bodo
    ...
    split_chm(split_neighbourhoods_gdb, neighbourhood_list, r_chm, gdb_split_chm)