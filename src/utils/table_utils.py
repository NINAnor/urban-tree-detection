...
class Excel:
    ...
    def importSheets(self):
        ...
        if self.file_path.endswith(".xlsx"):
            ...
            print('File {} contains {} sheets: {}'.format(self.file_name, len(self.ListSheet), ' , '.join(self.ListSheet)))
        else:
    ...
    def toPoint(self, output_dir, start, end):
        ...
        print("ArcPy Workspace for importing the excel sheets:", arcpy.env.workspace)
        ...
        for sheet in self.ListSheet[start:end]:
            ...
            print('Converting "{}" excel sheet to "{}" gdb table.'.format(sheet, out_table))
            ...
            print('Converting "{}" gdb table to "{}" point feature class.'.format(sheet, out_feature))
            arcpy.management.XYTableToPoint(out_table, out_feature, "longitude", "latitude", "altitude")
